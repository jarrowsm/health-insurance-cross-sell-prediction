...
- Feature engineering: interactions + derived features; prune via mean CV $\alpha$
- Feature encoding + selection (manual + automated)
- Stratified k-fold CV tuning: tree depth, criterion (Gini/entropy/log loss), $\eta$, rounds, weight factor, threshold, easy + hard sample removal
...
- HyperparameterTuning:
    ...
    - Job 2: marginal gain (increase $\eta$ + early stopping)
